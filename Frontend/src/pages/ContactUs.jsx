...
const ContactUs = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-gray-100 py-8 px-4 mt-16 animate-fadeIn">
      <div className="max-w-xl mx-auto bg-white rounded-lg shadow-lg p-6 transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] hover:bg-gray-50 animate-fadeIn">
        ...
        <form className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="animate-slideUp">
              ...
              <input
                ...
                name="firstName"
                placeholder="John"
                className="w-full px-3 py-2 rounded border border-gray-200 focus:border-brand-500 focus:ring-1 focus:ring-brand-200 transition-all duration-300"
                required
              />
            </div>
            <div className="animate-slideUp">
          ...
          <button
            type="submit"
            className="w-full py-2 px-4 bg-brand-500 hover:bg-brand-600 text-white font-medium rounded shadow hover:shadow-lg transition-all duration-200 transform hover:scale-105"
          >
            Send Message
          </button>
        </form>
        ...
        <div className="mt-8 grid grid-cols-3 gap-4 text-center text-sm">
          <a href="tel:+15551234567" className="group hover:text-brand-500 transition-colors duration-200 animate-slideUp">
            <div className="flex items-center justify-center w-10 h-10 mx-auto bg-brand-100 rounded-full group-hover:bg-brand-200 transition-transform duration-200 hover:scale-110">
          ...
          <a href="mailto:support@example.com" className="group hover:text-brand-500 transition-colors duration-200 animate-slideUp">
            <div className="flex items-center justify-center w-10 h-10 mx-auto bg-brand-100 rounded-full group-hover:bg-brand-200 transition-transform duration-200 hover:scale-110">
              <svg className="w-5 h-5 text-brand-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
          ...
          <a href="https://maps.google.com/?q=123+Business+Street" target="_blank" rel="noopener noreferrer" className="group hover:text-brand-500 transition-colors duration-200 animate-slideUp">
            <div className="flex items-center justify-center w-10 h-10 mx-auto bg-brand-100 rounded-full group-hover:bg-brand-200 transition-transform duration-200 hover:scale-110">
              <svg className="w-5 h-5 text-brand-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
              </svg>
